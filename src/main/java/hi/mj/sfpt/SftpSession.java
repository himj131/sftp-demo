...
public class SftpSession implements Session<SftpClient.DirEntry> {
        ...
        try {
            if(!this.sftpClient.isOpen()) {
                Duration initializationTimeout =
                    SftpModuleProperties.SFTP_CHANNEL_OPEN_TIMEOUT.getRequired(
                        this.sftpClient.getSession());
    ...
    public String getHostPort() {
        ...
        return SshdSocketAddress.toAddressString(connectAddress) + ':'
            + SshdSocketAddress.toAddressPort(connectAddress);
    }
