...
/**
 * A {@link ServerKeyVerifier} implementation for a {@link Resource} abstraction. The logic is
 * similar to the {@link KnownHostsServerKeyVerifier}, but in read-only mode.
 *
 * @author Artem Bilan
...
public class ResourceKnownHostsServerKeyVerifier implements ServerKeyVerifier {
    ...
    public boolean verifyServerKey(ClientSession clientSession, SocketAddress remoteAddress,
        ...
        KnownHostsServerKeyVerifier.HostEntryPair match = findKnownHostEntry(clientSession,
    ...
    private static KnownHostsServerKeyVerifier.HostEntryPair findKnownHostEntry(
        ...
        Collection<SshdSocketAddress> candidates = resolveHostNetworkIdentities(clientSession,
            remoteAddress);
